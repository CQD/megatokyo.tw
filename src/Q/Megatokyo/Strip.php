...
class Strip
{
    ...
    static $all = [
        ...
        ["2000-12-13", Chapter::C0, "噗啾～噗啾～","<p>第二格的布娃娃外星人出自迷糊女戰士（Excel Saga），第三格則是家有阿福（Alf）<p><iframe width='420' height='315' src='https://www.youtube.com/embed/LCZhI96Jzaw' frameborder='0' allowfullscreen></iframe> <p><iframe width='560' height='315' src='https://www.youtube.com/embed/Eo5tBDXyQno' frameborder='0' allowfullscreen></iframe>"],
